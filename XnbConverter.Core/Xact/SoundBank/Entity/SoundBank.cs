...
public class SoundBank
{
    ...
    public List<string> WaveBankNames = new List<string>();//Wave Bank的名称集合
    public List<SoundEntry> SoundEntrys = new List<SoundEntry>();//声音资源的集合
    public List<SoundCue> Cues = new List<SoundCue>();//Cue的集合
    ...
    public class SoundBankHeader
    {
        ...
        public List<byte[]> Unknowns = new List<byte[]>();//未知数据
